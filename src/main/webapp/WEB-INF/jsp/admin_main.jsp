...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-md-4">
            <div>
                <div><h4 class="m-0 font-weight-bold text-primary" style="padding: 20px 0px 0px 5px"> 用户管理 </h4>
                </div>
                                    ...
                                    <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                        ...
                                        <c:forEach items="${userList.list}" var="user">
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a  href="#" onclick="delUser(this)"
                                                        myAttr="/admin/userDel/${user.id}?pageNum=${userList.pageNum}"><i
                                                        class="fa fa-trash  fa-2x text-danger"
                                                        aria-hidden="true"></i></a></td>
                                                <td><a href="/admin/updatePage/${user.id}">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
                                         共 ${userList.pages} 页 , 总计 ${userList.total} 位用户
                                    </div>
                                </div>
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    text: 'delete user',
                    action: function () {
                        // var myAttr ="/admin/userDel/${user.id}?pageNum=${userList.pageNum}"
